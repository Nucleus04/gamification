...
function Menu({ reports }) {
    ...
    return (
        <MenuComponent navigate={navigate} reports={reports} />
    )
}
            ...
            <div className="ry_sidebar-style1 div-block-27">
                <div className="ry_sidebar-style1_top">
                    <div className="ry_side-menu-style1_container">
                        ...
                        {/* <Link to="/review" className="ry_sidemenu-link-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="ry_icon-side-embed w-embed"><svg id="Layer_1" data-name="Layer 1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <path className="cls-1"
                        ...
                        <Link to="/goals" className="ry_sidemenu-link-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="ry_icon-side-embed w-embed"><svg id="Layer_1" data-name="Layer 1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <path className="cls-1"
                        ...
                        {/* <Link to="/bonuses" className="ry_sidemenu-link-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="ry_icon-side-embed w-embed"><svg id="Layer_1" data-name="Layer 1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <path className="cls-1"
                        ...
                        {/* <Link to="#" className="ry_sidemenu-link-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="ry_icon-side-embed w-embed"><svg id="Layer_1" data-name="Layer 1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <path className="cls-1"
                            ...
                            <div className="ry_sidemenu-link-style2_add">
                                <div className="ry_embed-style1 w-embed"><svg id="Layer_1" data-name="Layer 1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <path className="cls-1"
                        ...
                        {/* <Link to="/members" className="ry_sidemenu-sublink-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="div-block-381"></div>
                                <div>Members</div>
                            </div>
                        </Link>
                        <Link to="/teams" className="ry_sidemenu-sublink-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="div-block-381"></div>
                                <div>Teams</div>
                            </div>
                        ...
                        <Link to="/reports" className="ry_sidemenu-link-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="ry_icon-side-embed w-embed"><svg id="Layer_1" data-name="Layer 1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <path className="cls-1"
                        ...
                        <div style={!this.props.reports ? { height: 0, display: "none", animation: "ease-in-out", animationDuration: "2s" } : {}}>
                            <Link to="/timesheets" className="ry_sidemenu-sublink-style1 w-inline-block">
                                <div className="sidemenu-link-style1_left">
                                    <div className="div-block-381"></div>
                                    <div>Timesheet</div>
                                </div>
                            </Link>
                            <Link to="/timeline" className="ry_sidemenu-sublink-style1 w-inline-block">
                                <div className="sidemenu-link-style1_left">
                                    <div className="div-block-381"></div>
                                    <div>Timeline</div>
                                </div>
                            </Link>
                            <Link to="/attendance" className="ry_sidemenu-sublink-style1 w-inline-block">
                                <div className="sidemenu-link-style1_left">
                                    <div className="div-block-381"></div>
                                    <div>Attendance</div>
                                </div>
                            </Link>
                            <Link to="/activity-level" className="ry_sidemenu-sublink-style1 w-inline-block">
                                <div className="sidemenu-link-style1_left">
                                    <div className="div-block-381"></div>
                                    <div>Activity Level</div>
                                </div>
                            </Link>
                            <Link to="/360-feedback" className="ry_sidemenu-sublink-style1 w-inline-block">
                                <div className="sidemenu-link-style1_left">
                                    <div className="div-block-381"></div>
                        ...
                        {/* <Link to="/insights" className="ry_sidemenu-sublink-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="div-block-381"></div>
                                <div>Insights</div>
                            </div>
                        </Link> */}
                        <Link to="/gamification" className="ry_sidemenu-link-style1 w-inline-block">
                            <div className="sidemenu-link-style1_left">
                                <div className="ry_icon-side-embed w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-award" viewBox="0 0 16 16"> <path className="cls-1" d="M9.669.864 8 0 6.331.864l-1.858.282-.842 1.68-1.337 1.32L2.6 6l-.306 1.854 1.337 1.32.842 1.68 1.858.282L8 12l1.669-.864 1.858-.282.842-1.68 1.337-1.32L13.4 6l.306-1.854-1.337-1.32-.842-1.68L9.669.864zm1.196 1.193.684 1.365 1.086 1.072L12.387 6l.248 1.506-1.086 1.072-.684 1.365-1.51.229L8 10.874l-1.355-.702-1.51-.229-.684-1.365-1.086-1.072L3.614 6l-.25-1.506 1.087-1.072.684-1.365 1.51-.229L8 1.126l1.356.702 1.509.229z" /> <path d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1 4 11.794z" /> </svg></div>
                                <div>Rewards</div>
                            </div>
                        </Link>
                    </div>
                ...
                <div className="ry_sidebar-style1_bottom">
                    ...
                    </a><a href="" onClick={this.handleSignout.bind(this)} className="ry_sidemenu-link-style1 w-inline-block">
                        <div className="sidemenu-link-style1_left">
                            <div className="ry_icon-side-embed w-embed"><svg id="Layer_1" data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                <path className="cls-1"
