...
class Header extends Component {
    ...
    render() {
        return (
            <div className={`ry_main-style1_top-nav ${this.state.showMenu ? "" : "width-0"}`}>
                <div className="ry_main-style1_top-nav_left">
                    <div className="ry_expand-icon" onClick={this.handleShowMenu.bind(this)}><img
                        src="https://assets.website-files.com/647edc411cb7ba0f95e2d12c/647ef7a89c37a63f95395f01_nav_01.svg"
                        loading="lazy" alt="" /></div><a href="#" className="ry_app-logo-style1 w-inline-block"><img
