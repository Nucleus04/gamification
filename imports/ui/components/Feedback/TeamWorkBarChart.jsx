...
class teamworkBarChart extends Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.state = {
        ...
        if (prevProps.feedbacks !== this.props.feedbacks) {
            this.props.feedbacks[0].reviews.forEach(element => {
                ...
                if (element.status === "done") {
                    self = self + element.teamwork.self;
                    Manager = Manager + element.teamwork.manager;
                    directReport = directReport + element.teamwork.direct_reports;
                    numberOfSurvey += 1;
                }
            });
        ...
        return (
            <div className="ry_review flex-vertical">
                <div className="ry_cardtop">
                    <div className="card_dashboard-label">Teamwork</div>
                </div>
