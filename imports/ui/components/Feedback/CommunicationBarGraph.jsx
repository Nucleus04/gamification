...
class CommunicationBarGraph extends Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.state = {
        ...
        if (prevProps.feedbacks !== this.props.feedbacks) {
            this.props.feedbacks[0].reviews.forEach(element => {
                ...
                if (element.status === "done") {
                    self = self + element.communication.self;
                    Manager = Manager + element.communication.manager;
                    directReport = directReport + element.communication.direct_reports;
                    numberOfSurvey += 1;
                }
            });
...
export default CommunicationBarGraph;
